...
<body style="background-color: #f2f2f2">
	<nav class="navbar navbar-dark bg-white">
		<div class="navbar-header">
			<a href="index.jsp"><img src="img/echo_account3.png" />
		</div>
	</nav>
...
<!-- 로그인 버튼만 구현됨 -->
							...
							<div href="loginproc.jsp">
								<button type="button" class="btn btn-light">Login
								</button>
							</div>
							
							<div class="mt-4 text-center">
							<a href="forgot.jsp"class="float-left"> 비밀번호 찾기 </a> 
							<a href="register.jsp" class="float-right">계정 생성</a>	
